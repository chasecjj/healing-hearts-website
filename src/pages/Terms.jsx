    ...
    <div className="w-full bg-background pt-32 md:pt-48 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-white rounded-[3rem] p-8 md:p-12 lg:p-16 shadow-xl border border-primary/5 space-y-8 font-sans text-foreground/80 font-light leading-relaxed">
          ...
          <section>
            <h2 className="font-outfit font-bold text-2xl text-primary mb-4">3. Term, Financial Provisions, and Termination</h2>
            <div className="space-y-4">
              <p>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Share your login credentials with anyone outside of your immediate relationship.</li>
                <li>Upload, post, or display any Content on social media, file-sharing sites, websites, or public forums.</li>
                <li>Email, transfer, or digitally send the course materials to friends, family members, or other couples.</li>
          ...
          <section>
            <h2 className="font-outfit font-bold text-2xl text-primary mb-4">5. Indemnification and Limitation of Liability</h2>
            <div className="space-y-4">
              <p>
          ...
          <section>
            <h2 className="font-outfit font-bold text-2xl text-primary mb-4">6. Miscellaneous Provisions</h2>
            <div className="space-y-4">
              <p>
                <strong>6.1 Entire Agreement:</strong> This Agreement constitutes the entire agreement between the parties with respect to the subject matter hereof and supersedes all prior agreements, negotiations, and understandings, oral or written, between the parties.
              </p>
              <p>
              ...
              <p>
                <strong>6.5 Waiver:</strong> The failure of either party to enforce any right or provision of this Agreement will not constitute a waiver of future enforcement of that right or provision. Any waiver of a provision must be in writing and signed by a duly authorized representative of the waiving party.
              </p>
            </div>
          </section>

          <section>
            <h2 className="font-outfit font-bold text-2xl text-primary mb-4">7. Governing Law and Dispute Resolution</h2>
            <div className="space-y-4">
              <p>
                <strong>7.1 Governing Law:</strong> This Agreement shall be governed by and construed in accordance with the laws of the State of Utah, without regard to its conflict of law principles.
              </p>
              <p>
                <strong>7.2 Venue for Disputes:</strong> The parties agree that any dispute, claim, or controversy arising out of or relating to this Agreement shall be subject to the exclusive jurisdiction and venue of the courts located in Utah, USA.
              </p>
            </div>
          </section>
