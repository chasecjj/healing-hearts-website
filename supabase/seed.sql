...
BEGIN
  ...
  -- Module 7.4: The Path to True Intimacy (parent + 4 sub-lessons)
  ...
  (mod_id, parent_lesson_id, 'Foundations & Safety', 5, true, '{"estimated_minutes":35,"blocks":[{"type":"text","content":"Trust, commitment, the SPARK tool, sliding door moments, and healing betrayal trauma."}]}'),
