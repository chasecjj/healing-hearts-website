...
export function followupEmail(name, webinar) {
  ...
  const previewText = 'We keep our program intentionally small -- and we have a few spots left.';

  const body = [
    heading('A Quick Update on Enrollment'),
    paragraph(`${safeName}, I wanted to let you know where things stand.`),
    paragraph('Applications for the next Healing Hearts cohort close at the end of this week. We keep our groups intentionally small -- usually eight to ten couples -- because the kind of work we do requires real attention. Not a lecture hall. Not a passive webinar. Actual, hands-on guidance with Jeff and our team walking alongside you.'),
    paragraph('That means space is limited, and it fills up. Not because of artificial scarcity -- because we genuinely cannot support more couples than that and do it well.'),
    ...
    paragraph('If the timing is not right, that is completely okay. We run new cohorts regularly, and you are always welcome to apply when you are ready. But if that quiet voice has been nudging you -- this is worth listening to.'),
