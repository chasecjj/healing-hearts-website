...
export function dayEmail() {
  ...
  const body = [
    ...
    paragraph("You know, it's so easy in the hustle and bustle of life &mdash; the school runs, the deadlines, the dinner dilemmas &mdash; to start seeing our partners through a bit of a blurry lens. We see the 'to-do list' version of them, or maybe the 'habit' version. And sometimes, we just forget to really look."),
    ...
    callout("And that's the magic of what we're doing today! Today's challenge is all about The 'I Noticed' Text. It's about intentionally looking for the good, the sweet, the funny, the thoughtful &mdash; those little things that often go unseen."),
