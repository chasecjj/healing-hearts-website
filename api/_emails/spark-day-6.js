...
export function dayEmail() {
  ...
  const body = [
    ...
    paragraph("You know, when life gets busy -- and oh, does it get busy! -- we can sometimes lose touch with the very foundation of our relationship. We get caught up in the to-do lists, the routines, the responsibilities, and we forget the magic of how it all began. We forget those early days, those inside jokes, those moments that cemented your bond."),
    paragraph("I remember a few years ago, Jeff and I were going through a really tough patch. We were both exhausted, stressed, and it felt like we were just roommates coexisting. One night, we were cleaning out a closet, and I stumbled upon a box of old photos. There was one of us, crammed into his tiny first apartment, trying to cook a gourmet meal for my birthday. It was a disaster -- the smoke alarm went off, we burnt everything, and ended up ordering pizza. But in that moment, looking at that blurry photo, I remembered how much we laughed that night. How we just rolled with it, how easy and fun we were together."),
    ...
    signOff(
      ...
      "Day 7: The Spark Conversation -- the most direct and loving way to keep your connection vibrant.",
    ),
  ].join('\n');
