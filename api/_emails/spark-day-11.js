...
export function dayEmail() {
  ...
  const body = [
    ...
    paragraph("It is the bedtime conversations that stopped. You used to talk about everything &mdash; your fears, your dreams, the weird thought you had in the shower. Now the last thing you say before sleep is \"goodnight.\" Or nothing at all."),
    paragraph("It is your kids watching. They do not miss as much as you think. They see the way you avoid each other in the kitchen. They notice when one of you leaves the room as soon as the other walks in. They are learning right now what love looks like &mdash; and what it does not."),
    paragraph("It is the dreams you stopped mentioning. The trip you wanted to take together. The business you wanted to start. The version of your marriage you imagined on your wedding day. At some point, you stopped bringing those things up &mdash; not because you stopped wanting them, but because it hurt too much to want something that felt impossible."),
    paragraph("It is the slow, quiet erosion of hope. Not a dramatic breaking point &mdash; just a gradual settling into \"this is just how it is.\""),
    callout("\"The couples who wait for the perfect time are the same couples who eventually run out of time.\" &mdash; Jeff Jamison, DO"),
