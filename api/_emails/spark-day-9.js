...
export function dayEmail(email) {
  ...
  const body = [
    ...
    paragraph("David had already talked to an attorney. Breanne was looking at apartments. They had not had a real conversation in months &mdash; just logistics about the kids and cold silences in between."),
    ...
    paragraph("Breanne started crying. Not because she was sad &mdash; because she had never heard him say that. In sixteen years of marriage, she had never known that their honeymoon was the last time he felt safe enough to be fully himself."),
    ...
    paragraph("David and Breanne are not special. They are not unusually brave or emotionally gifted. They are two ordinary people who decided to do something extraordinary &mdash; they chose to fight for their marriage instead of against each other."),
    paragraph("This is what becomes possible when you do the deep work. Not surface-level tips. Not communication hacks. The real, honest, sometimes uncomfortable work of learning who you are together &mdash; and who you could be."),
    signOff(
