...
export function followupEmail(name, webinar) {
  ...
  const body = [
    ...
    paragraph('But somewhere around the halfway point, something shifted. Jeff was explaining how the Critter Brain works -- how it hijacks a conversation and turns your partner into a threat instead of a teammate. Marcus put his phone down. He looked at Eliana for the first time all evening.'),
    ...
    paragraph('A week later, they applied to the Healing Hearts program. Not because the workshop fixed everything -- it did not. But because it showed them what was possible. It gave them a shared language for the patterns they had been stuck in.'),
    paragraph('Over the next eight weeks, they learned to identify their Core Wounds -- the deeper injuries underneath every surface-level argument. They practiced the 90-Second Wave when things got heated. They started having conversations that actually went somewhere instead of looping back to the same hurt.'),
    subheading('Six Months Later'),
    paragraph('Eliana told me something I will never forget:'),
    callout('"I used to dread coming home. Now I look forward to it. Not because everything is perfect -- but because I finally feel like we are on the same team."'),
    paragraph('Marcus and Eliana are not extraordinary people. They are a regular couple who made one decision -- to stop waiting for things to get better on their own and start doing the work together.'),
