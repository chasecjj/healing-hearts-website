...
export function followupEmail(name, webinar) {
  ...
  const body = [
    ...
    paragraph(`${safeName}, this is the last email in this series -- and I want to be honest with you.`),
    ...
    paragraph('Maybe your marriage is in crisis and you are looking for a lifeline. Maybe you are in that quiet "fine" zone -- not terrible, but not what you dreamed of either. Maybe things are actually pretty good and you want them to be great. Wherever you are, the fact that you have been reading these emails means something.'),
    callout('There is no expiration date on healing. There is no deadline after which your marriage cannot change. We have seen couples come back from places that felt impossible -- and they have done it at every age, every stage, and after every kind of hurt.'),
    paragraph('So here is what I want you to know:'),
    paragraph('The door is always open. If right now is the time, we are here. If you need six more months, we will still be here. If you never join our program but something from the workshop or these emails shifted the way you see your partner -- that is enough. That matters.'),
    paragraph('But if you are feeling that pull -- that quiet voice saying "maybe this is the year" -- I want to encourage you to listen to it. Not because we want your business, but because we have watched too many couples wait until the pain got unbearable before they asked for help. And every single one of them said the same thing:'),
