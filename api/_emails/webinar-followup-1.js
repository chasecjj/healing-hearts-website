...
export function followupEmail(name, webinar) {
  ...
  const body = [
    ...
    paragraph(`Whether you joined us live for <strong>${safeTitle}</strong> or life had other plans today &mdash; we are glad you are here. The fact that you signed up tells us something about your heart.`),
    ...
    callout('Something Jeff often says: "Insight without action is just entertainment." If something resonated with you today &mdash; a phrase, a framework, a moment of recognition &mdash; that is worth paying attention to.'),
    paragraph('So here is a gentle question: what do you want to do with what you felt?'),
    paragraph('If you are curious about what the deeper work looks like &mdash; the kind of sustained, guided transformation that turns a single workshop into lasting change &mdash; we would love to tell you more.'),
    divider(),
