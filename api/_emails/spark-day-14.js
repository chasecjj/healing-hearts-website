...
export function dayEmail() {
  ...
  const body = [
    ...
    paragraph("This is our last email together &mdash; at least for now &mdash; and I want to be real with you."),
    ...
    callout("There is no expiration date on healing. There is no deadline after which your marriage cannot change. I have seen couples come back from places that felt impossible &mdash; and I have seen them do it at every age, every stage, and after every kind of hurt."),
    paragraph("So here is what I want you to know:"),
    paragraph("The door is always open. If right now is the time, we are here. If you need six more months, we will still be here. If you never join our program but something in these emails shifted the way you see your partner &mdash; that is enough. That matters."),
    paragraph("But if you are feeling that pull &mdash; that quiet voice saying \"maybe this is the year\" &mdash; I want to encourage you to listen to it. Not because I want your business, but because I have watched too many couples wait until the pain got unbearable before they asked for help. And every single one of them said the same thing: \"I wish we had started sooner.\""),
