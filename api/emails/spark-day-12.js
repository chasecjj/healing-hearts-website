...
export function dayEmail() {
  ...
  const body = [
    ...
    bulletList([
      "<strong>The nervous system patterns running your marriage</strong> -- why your body reacts before your brain catches up, and how to interrupt the cycle",
      "<strong>The one question that reveals the real issue</strong> -- most couples fight about the wrong thing for years. We will show you how to find what is actually underneath.",
      "<strong>What 8 months of deep work looks like</strong> -- a transparent walkthrough of the Healing Hearts journey, from the first module to the transformation on the other side",
