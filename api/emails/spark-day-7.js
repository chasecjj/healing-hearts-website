...
export function dayEmail() {
  ...
  const body = [
    ...
    paragraph("Throughout this challenge, we've focused on small, intentional acts -- noticing, listening, pausing, appreciating, remembering. These are all incredible ways to nurture your relationship. But sometimes, even with the best intentions, we can still be guessing. We think we know what our partner needs, or what would make them feel loved, but we don't always ask directly."),
    ...
    numberedList([
      'Ask the Question: Find a dedicated 15 minutes with your partner today -- turn off distractions, silence phones, and give each other your full presence. Take turns asking each other: "What\'s one small thing I could do this week that would make you feel loved?"',
      'Listen Deeply (No Interruptions!): When your partner shares their "one thing," listen with an open heart and mind. Do not interrupt, explain, defend, or problem-solve. Your only job is to hear and understand their request. It should be a small, specific, and actionable request -- not "be more affectionate" but "give me a hug when I get home." Not "help more" but "take out the trash on Tuesdays."',
    ...
    paragraph('<strong>You did it!</strong> You\'ve completed the 7-Day Spark Challenge. These 7 tools are yours to keep -- use them anytime your connection needs a little boost.'),
    callout("If you're ready to go deeper, our full Healing Hearts program takes these foundations and builds something extraordinary. No pressure -- just an invitation when you're ready."),
